    ...
    <div className="min-h-screen relative flex items-start sm:items-center justify-center p-4 pb-32 sm:pb-4">
      ...
      <div className="container max-w-6xl mx-auto relative z-10 mt-8 sm:mt-0">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white font-semibold drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] max-w-2xl mx-auto">
      ...
      <div className="absolute bottom-4 left-0 right-0 z-10">
        <div className="text-center text-sm text-foreground/70 backdrop-blur-sm bg-background/30 py-3 px-4 rounded-lg mx-auto max-w-md">
          <Link to="/auth">
            <Button variant="ghost" size="sm" className="mb-2 text-xs hover:text-primary">
              Admin Login
            </Button>
          </Link>
          ...
          <div className="flex items-center justify-center gap-4">
            <a
              href="https://instagram.com/sa1ffffff"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-pink-500 transition-colors duration-200 flex items-center gap-1"
            >
